...
import { LoginValues, UserValues } from "Interface/auth";
    ...
    return (
        ...
        >
            <div className="w-full p-5">
                <div
                    className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 border rounded-lg shadow-lg bg-white px-10 py-5 w-4/5 sm:w-1/2 md:w-2/5"
                    // style={{ maxWidth: "550px", minWidth: "480px" }}
                >
                    <form onSubmit={handleSubmit(onSubmit, onError)}>
                        ...
                        <div>
                            ...
                            <button
                                type="submit"
                                className="text-white focus:outline-none focus:ring-4  font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 w-full bg-red-500 hover:bg-red-800 duration-300"
                            >
                                Đăng nhập
                            </button>
                        </div>
